    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="flex flex-col items-center justify-center px-6 py-20 text-center sm:py-32 max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 mb-8 rounded-full bg-blue-100 text-blue-700 text-sm font-medium">
          ...
          <span>{t("home.feature_1_title")}</span>
        </div>
        ...
        <form onSubmit={handleTextSearch} className="w-full max-w-2xl bg-white p-2 rounded-2xl shadow-lg border border-slate-200 flex flex-col sm:flex-row gap-2">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">{locating ? t("search.locating") : t("home.locate_me")}</span>
            </button>
            <button 
               type="submit"
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-slate-900">{t("home.feature_1_title")}</h3>
                      </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-slate-900">{t("home.feature_2_title")}</h3>
                      </div>
                      <p className="text-slate-500 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-slate-900">{t("home.feature_3_title")}</h3>
                      </div>
                      <p className="text-slate-500 leading-relaxed">
